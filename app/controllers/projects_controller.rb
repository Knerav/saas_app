class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:name, :details, :expected_completion_date, :tenant_id)
    end
    ...
    def verify_tenant
      unless params[:tenant_id] == Tenant.current_tenant_id.to_s
        ...
        flash[:error] = "You are not authorised to access any other organisations projects"
      end
    end
